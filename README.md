# 🚀 Virendra Sahu – Full Stack Developer Portfolio

Hi, I'm **Virendra Sahu**, a Computer Science student at **National Institute of Technology (NIT) Hamirpur, Himachal Pradesh**.

I specialize in building **scalable, real-world applications** using Flutter and modern backend technologies.
...
## 🔷 Hillfair 2k24 – Event Management & Social Interaction Platform

**🔗 GitHub Repository:**
https://github.com/appteam-nith/Hill-ffair_Frontend_2K24

**📱 Play Store:**
https://play.google.com/store/apps/details?id=com.appteam.hillfair2k24
...
**Challenge:** Handling high real-time message traffic
**Solution:** Optimized API calls and efficient state management

**Challenge:** Maintaining app performance during peak usage
**Solution:** Reduced unnecessary re-renders and optimized backend responses
